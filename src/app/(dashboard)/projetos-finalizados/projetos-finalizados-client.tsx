...
interface ProjetosFinalizadosClientProps {
  cards: CardKanban[]
...
// Colunas para projetos finalizados (visualização simples)
const columns = [
...
export function ProjetosFinalizadosClient({
  cards: initialCards,
  projetos,
  clientes,
  usuarios,
}: ProjetosFinalizadosClientProps) {
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-sm text-muted-foreground">
          Projetos FEE que foram finalizados apos o fluxo de relatorios
        </p>
